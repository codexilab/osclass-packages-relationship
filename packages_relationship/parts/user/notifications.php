...
<?php if ($events) : ?>
	...
	<small><?php echo osc_format_date($event['dt_date'], osc_date_format()); ?> <a href="javascript:void(0);" onclick="packages_relationship_action('delete_event', <?php echo $event['fk_i_from_user_id'] ?>, <?php echo $event['pk_i_id'] ?>);return false;">[x]</a></small><br /><br />
	<?php endforeach; ?>
<?php else : ?>
